...
####  <b>Expected success behavior</b>
 ...
 + If the SD Card is missing, an error is shown on the HyperTerminal: "FX media opening failed". Prepare an SD Card with FAT32 File System, copy the content of "Web_Content" folder into the SD Card, plug the SD into the board socket and reset the board.
